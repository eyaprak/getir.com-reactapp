  ...
  return (
    <>
      <div className='bg-brand-color'>
        <div className='container mx-auto h-16 md:h-11 flex items-center justify-center md:justify-between  max-w-7xl'>
          <a href='!#'>
            <img
          ...
          <nav className='hidden md:flex gap-x-8 text-sm font-semibold px-2'>
            <a
              href='#'
      ...
      <div className='container mx-auto flex md:hidden items-center h-10 px-2 justify-between'>
        <div className='flex items-center gap-x-2 text-sm font-semibold text-gray-800 justify-between'>
          <HiLocationMarker size={18} className='text-primary-brand-color' />
          Teslim adresi Belirle
        </div>
